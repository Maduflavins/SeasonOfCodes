public class AutoPolicyTest
{
	...
	{
		AutoPolicy policy1 = new AutoPolicy(111, "Toyota Camry", "PA");
	...
	public static void policyInNoFaultState(AutoPolicy policy)
	{
		...
		System.out.printf("Account No.: %d; Car: %s; State %s %s a no-fault state%n%n", policy.getAccountNumber(), policy.getMakeAndModel(), policy.getState(), (policy.isNoFaultState() ? "is": "is not"));
	}
}
